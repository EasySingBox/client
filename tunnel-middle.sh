...
if [ -z "$1" ]; then
    ...
    echo "使用方式: bash <(curl -Ls https://codeberg.org/easy-sing-box/client/raw/main/tunnel-middle.sh) <CENTRAL_API> [FINAL_SERVER_IP] [FINAL_SERVER_PORT] [FINAL_SERVER_PWD] [FINAL_SERVER_VPS_ORG] [FINAL_SERVER_COUNTRY]"
    exit 1
fi
